<x-layoutFull>
    <div class="bg-cover bg-center bg-no-repeat h-screen" style="background-image: url('{{ asset('img/background-beer.jpg') }}');">
        <x-slot name="title">Connexion</x-slot>
        <div class="flex items-center justify-center h-full">
            <div class="max-w-4xl mx-auto p-8 shadow-md" style="background-color: rgba(255, 255, 255, 0.9);">
                ...
                <form action="{{ route('login') }}" method="post">
                    ...
                    <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-full">Connexion</button>
                </form>
            </div>
        </div>
    </div>
