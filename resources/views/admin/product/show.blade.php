<x-layout>
        <div class="w-full max-w-screen-xl">
            <a href="{{ route('products.index') }}" class="text-blue-500 hover:text-blue-600">Retour à la page précédente</a>
                ...
                <div class="flex-1 p-8 flex items-start">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-center">
                            <button class="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded mr-2">Modifier l'article</button>
